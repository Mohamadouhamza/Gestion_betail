...
class _MouvementScreenState extends State<MouvementScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Nouveau mouvement', style: GoogleFonts.poppins()),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Wrap(
              spacing: 8,
              children: CategorieAnimal.values.map((cat) {
                return ChoiceChip(
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                hintText: 'Prix unitaire ou total',
                border: OutlineInputBorder(borderRadius: BorderRadius.circular(12)),
            ...
            if (_type.sens == 'entree') ...[
              CheckboxListTile(
                title: Text('Créer un nouveau lot (date naissance/entrée)', style: GoogleFonts.poppins()),
                value: _nouveauLot,
              ...
              if (_nouveauLot) ...[
                ListTile(
                  ...
                  title: Text('Date naissance/entrée : ${DateFormat('dd/MM/yyyy').format(_dateNaissance)}'),
                  trailing: const Icon(Icons.arrow_forward_ios, size: 16),
                  onTap: () async {
                    final picked = await showDatePicker(
                      context: context,
