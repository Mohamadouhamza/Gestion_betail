...
class HomeScreen extends StatelessWidget {
          ...
          return CustomScrollView(
            slivers: [
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: DropdownButtonHideUnderline(
                                child: DropdownButton<Proprietaire>(
                                  ...
                                  hint: const Text('Sélectionner un propriétaire'),
                                  items: provider.proprietaires.map((p) {
                                    return DropdownMenuItem(
                                      value: p,
                                      child: Text(p.nom, style: GoogleFonts.poppins()),
                                    );
                                  }).toList(),
                                  onChanged: (p) {
                                    if (p != null) provider.selectionnerProprietaire(p);
                                  },
                                ),
                              ),
                            ),
                            IconButton(
                              ...
                              onPressed: () => _showAjouterProprietaire(context),
                            ),
                          ],
                        ),
                      ),
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: DropdownButtonHideUnderline(
                                child: DropdownButton<Troupeau>(
                                  ...
                                  hint: const Text('Sélectionner un troupeau'),
                                  items: provider.troupeaux.map((t) {
                                    return DropdownMenuItem(
                                      value: t,
                                      child: Text('${t.nom} ${t.code != null ? '(${t.code})' : ''}', 
                                        style: GoogleFonts.poppins()),
                                    );
                                  }).toList(),
                                  onChanged: (t) {
                                    if (t != null) provider.selectionnerTroupeau(t);
                                  },
                                ),
                              ),
                            ),
                            IconButton(
                              icon: const Icon(Icons.add_circle_outline),
                              onPressed: () => _showAjouterTroupeau(context),
                            ),
                          ],
                        ),
                      ),
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      IconButton(
                        ...
                        onPressed: () => provider.rafraichirDonnees(),
                      ),
                    ],
                  ),
                ),
                  ...
                  delegate: SliverChildListDelegate([
                    CarteSituation(
                      ...
                      onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => const InventaireScreen(categorie: CategorieAnimal.taurion),
                        ),
                      ),
                    ),
                    CarteSituation(
                      ...
                      onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => const InventaireScreen(categorie: CategorieAnimal.genisse),
                        ),
                      ),
                    ),
                    CarteSituation(
                      ...
                      onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => const InventaireScreen(categorie: CategorieAnimal.vache),
                        ),
                      ),
                    ),
                    CarteSituation(
              ...
              SliverToBoxAdapter(
                child: Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 16),
                  child: CarteGestation(valeur: provider.situation.gestation),
                ),
              ),
                  ...
                  child: Card(
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          _buildResumeItem('Veaux total', provider.situation.veauxTotal, Icons.add_circle),
                          Container(height: 40, width: 1, color: Colors.grey.shade300),
                          _buildResumeItem('En gestation', provider.situation.gestation, Icons.pregnant_woman),
                        ],
                      ),
                    ),
                  ),
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        ...
                        trailing: mouv.prix != null
                            ? Text('${mouv.prix!.toStringAsFixed(0)} F', 
                                style: GoogleFonts.poppins(fontWeight: FontWeight.w600))
                            : null,
                      ),
                    );
                  },
                  childCount: provider.mouvementsRecents.length > 5 ? 5 : provider.mouvementsRecents.length,
                ),
              ),
  ...
  Widget _buildResumeItem(String label, int value, IconData icon) {
    return Column(
      children: [
  ...
  void _showAjouterProprietaire(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        title: Text('Nouveau propriétaire', style: GoogleFonts.poppins()),
        content: TextField(
          controller: ctrl,
          ...
          ElevatedButton(
            onPressed: () {
              if (ctrl.text.isNotEmpty) {
                context.read<TroupeauProvider>().ajouterProprietaire(ctrl.text);
                Navigator.pop(ctx);
              }
            },
  ...
  void _showAjouterTroupeau(BuildContext context) {
    ...
    showDialog(
      context: context,
      builder: (ctx) => AlertDialog(
        title: Text('Nouveau troupeau', style: GoogleFonts.poppins()),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            TextField(controller: nomCtrl, decoration: const InputDecoration(labelText: 'Nom')),
            TextField(controller: codeCtrl, decoration: const InputDecoration(labelText: 'Code (ex : AH)')),
          ],
        ),
        actions: [
          TextButton(onPressed: () => Navigator.pop(ctx), child: const Text('Annuler')),
          ElevatedButton(
            onPressed: () {
              if (nomCtrl.text.isNotEmpty) {
                context.read<TroupeauProvider>().ajouterTroupeau(nomCtrl.text, code: codeCtrl.text);
                Navigator.pop(ctx);
              }
            },
            child: const Text('Ajouter'),
