...
class FicheScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Fiche de suivi', style: GoogleFonts.poppins()),
  ...
  Widget _buildResumeCard(String code, int valeur, MaterialColor couleur) {
    return Container(
      width: 80,
      ...
      child: Column(
        children: [
          ...
          Text(
            '$valeur',
            style: GoogleFonts.poppins(fontSize: 20, fontWeight: FontWeight.bold, color: couleur.withOpacity(0.8)),
          ),
        ],
      ),
    );
